# EdFi.OdsApi.Sdk.v73.Apis.All.ClassPeriodsApi
...
# **GetClassPeriods**
> List&lt;EdFiClassPeriod&gt; GetClassPeriods (int? offset = null, int? limit = null, string? pageToken = null, int? pageSize = null, long? minChangeVersion = null, long? maxChangeVersion = null, bool? totalCount = null, string? classPeriodName = null, long? schoolId = null, string? id = null, bool? officialAttendancePeriod = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetClassPeriodsExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiClassPeriod> result = apiInstance.GetClassPeriods(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiClassPeriod>> response = apiInstance.GetClassPeriodsWithHttpInfo(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="getclassperiodspartitions"></a>
# **GetClassPeriodsPartitions**
> GetAbsenceEventCategoryDescriptorsPartitions200Response GetClassPeriodsPartitions (int? number = null, long? minChangeVersion = null, long? maxChangeVersion = null, string? classPeriodName = null, long? schoolId = null, string? id = null, bool? officialAttendancePeriod = null, bool? useSnapshot = null)
...
namespace Example
{
    public class GetClassPeriodsPartitionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves a set of page tokens to be used for efficient client-side parallel processing.
                GetAbsenceEventCategoryDescriptorsPartitions200Response result = apiInstance.GetClassPeriodsPartitions(number, minChangeVersion, maxChangeVersion, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ClassPeriodsApi.GetClassPeriodsPartitions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetClassPeriodsPartitionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a set of page tokens to be used for efficient client-side parallel processing.
    ApiResponse<GetAbsenceEventCategoryDescriptorsPartitions200Response> response = apiInstance.GetClassPeriodsPartitionsWithHttpInfo(number, minChangeVersion, maxChangeVersion, classPeriodName, schoolId, id, officialAttendancePeriod, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling ClassPeriodsApi.GetClassPeriodsPartitionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
