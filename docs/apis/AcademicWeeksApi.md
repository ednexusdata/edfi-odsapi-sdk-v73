# EdFi.OdsApi.Sdk.v73.Apis.All.AcademicWeeksApi
...
namespace Example
{
    public class GetAcademicWeeksExample
    {
        public static void Main()
        {
            ...
            var beginDate = DateOnly.Parse("2013-10-20");  // DateOnly | The start date for the academic week.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. (optional) 
            var endDate = DateOnly.Parse("2013-10-20");  // DateOnly | The end date for the academic week.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. (optional) 
            ...
            {
                // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
                List<EdFiAcademicWeek> result = apiInstance.GetAcademicWeeks(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, weekIdentifier, schoolId, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Retrieves specific resources using the resource's property values (using the \"Get\" pattern).
    ApiResponse<List<EdFiAcademicWeek>> response = apiInstance.GetAcademicWeeksWithHttpInfo(offset, limit, pageToken, pageSize, minChangeVersion, maxChangeVersion, totalCount, weekIdentifier, schoolId, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
| **beginDate** | **DateOnly** | The start date for the academic week.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. | [optional]  |
| **endDate** | **DateOnly** | The end date for the academic week.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. | [optional]  |
| **id** | **string** |  | [optional]  |
...
<a id="getacademicweekspartitions"></a>
# **GetAcademicWeeksPartitions**
> GetAbsenceEventCategoryDescriptorsPartitions200Response GetAcademicWeeksPartitions (int number = null, long minChangeVersion = null, long maxChangeVersion = null, string weekIdentifier = null, long schoolId = null, DateOnly beginDate = null, DateOnly endDate = null, string id = null, int totalInstructionalDays = null, bool useSnapshot = null)
...
namespace Example
{
    public class GetAcademicWeeksPartitionsExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                // Retrieves a set of page tokens to be used for efficient client-side parallel processing.
                GetAbsenceEventCategoryDescriptorsPartitions200Response result = apiInstance.GetAcademicWeeksPartitions(number, minChangeVersion, maxChangeVersion, weekIdentifier, schoolId, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AcademicWeeksApi.GetAcademicWeeksPartitions: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the GetAcademicWeeksPartitionsWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Retrieves a set of page tokens to be used for efficient client-side parallel processing.
    ApiResponse<GetAbsenceEventCategoryDescriptorsPartitions200Response> response = apiInstance.GetAcademicWeeksPartitionsWithHttpInfo(number, minChangeVersion, maxChangeVersion, weekIdentifier, schoolId, beginDate, endDate, id, totalInstructionalDays, useSnapshot);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling AcademicWeeksApi.GetAcademicWeeksPartitionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
