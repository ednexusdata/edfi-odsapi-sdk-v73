...
namespace EdFi.OdsApi.Sdk.v73.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "edFi_dualCreditInstitutionDescriptor")]
    public partial class EdFiDualCreditInstitutionDescriptor : IValidatableObject
    {
        ...
        protected EdFiDualCreditInstitutionDescriptor() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdFiDualCreditInstitutionDescriptor" /> class.
        /// </summary>
        ...
        public EdFiDualCreditInstitutionDescriptor(string id = default, string codeValue = default, string varNamespace = default, string description = default, DateOnly? effectiveBeginDate = default, DateOnly? effectiveEndDate = default, string shortDescription = default, string etag = default, DateTime lastModifiedDate = default)
        {
            // to ensure "codeValue" is required (not null)
            if (codeValue == null)
            {
                throw new ArgumentNullException("codeValue is a required property for EdFiDualCreditInstitutionDescriptor and cannot be null");
            }
            this.CodeValue = codeValue;
            // to ensure "varNamespace" is required (not null)
            if (varNamespace == null)
            {
                throw new ArgumentNullException("varNamespace is a required property for EdFiDualCreditInstitutionDescriptor and cannot be null");
            }
            this.Namespace = varNamespace;
            // to ensure "shortDescription" is required (not null)
            if (shortDescription == null)
            {
                throw new ArgumentNullException("shortDescription is a required property for EdFiDualCreditInstitutionDescriptor and cannot be null");
            }
