...
namespace EdFi.OdsApi.Sdk.v73.Models.All
{
    ...
    public partial class EdFiStaffProgramAssociation : IValidatableObject
    {
        ...
        /// <param name="beginDate">Start date for the association of staff to this program.  Note: Date interpretation may vary. Ed-Fi recommends inclusive dates, but states may define dates as inclusive or exclusive. For calculations, align with local guidelines. (required).</param>
