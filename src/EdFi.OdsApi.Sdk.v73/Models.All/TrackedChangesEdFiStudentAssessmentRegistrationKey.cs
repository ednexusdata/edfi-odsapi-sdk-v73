...
namespace EdFi.OdsApi.Sdk.v73.Models.All
{
    ...
    /// </summary>
    [DataContract(Name = "trackedChanges_edFi_studentAssessmentRegistrationKey")]
    public partial class TrackedChangesEdFiStudentAssessmentRegistrationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentAssessmentRegistrationKey(string administrationIdentifier = default, string assessmentIdentifier = default, long assigningEducationOrganizationId = default, string varNamespace = default, long educationOrganizationId = default, string studentUniqueId = default)
        {
