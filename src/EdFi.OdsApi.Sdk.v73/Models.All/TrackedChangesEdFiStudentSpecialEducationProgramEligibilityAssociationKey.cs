...
namespace EdFi.OdsApi.Sdk.v73.Models.All
{
    ...
    public partial class TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey : IValidatableObject
    {
        ...
        public TrackedChangesEdFiStudentSpecialEducationProgramEligibilityAssociationKey(DateOnly consentToEvaluationReceivedDate = default, long educationOrganizationId = default, long programEducationOrganizationId = default, string programName = default, string programTypeDescriptor = default, string studentUniqueId = default)
        {
